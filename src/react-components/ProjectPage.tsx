...
import { closeModal } from "../classes/Modal";
import { toggleModal } from "../classes/Modal";
import { showModal } from "../classes/Modal";
...
<div className="page" id="project-page" style={{ display: "flex" }}>
  ...
  <header id="page-header">
    ...
    <div>
      <button onClick={onimportBtnClick} id="import-btn" className="fa-solid fa-upload">
        <span className="material-icon-round">Import</span>
      </button>
      <button onClick={onexportBtnClick} id="export-btn" className="fa-solid fa-download">
        <span className="material-icon-round">Export</span>
      </button>
      <button onClick={onnewProjectBtnClick} id="new-project-btn" className="fa-solid fa-plus">
        <span className="material-icon-round">New Project</span>
      </button>
    </div>
  </header>
  {
